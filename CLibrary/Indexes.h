...
//    }
//
//    if (graphsD0 == true) this->graphR(0, false);
//    if (graphsD1 == true) this->graphR(1, false);
//
//    if (calculateShift == true && useSumOfIndexesForAlignment == true) {
//        if (graphsD0Shift == true) this->graphR(0, true);
//        if (graphsD1Shift == true) this->graphR(1, true);
//    }
    ...
    // in a .csv file
//    if (saveIndexesToCsv == true) {
//        this->saveIndexesToCsvFile();
//    }

}


void Indexes::readDataPython(double *exp_data_x,
                             double *exp_data_y,
                             int exp_data_size,
                             double *model_data_x,
                             double *model_data_y,
    ...
    // string modelName = model_name_char;
    ...
    vector<double> exp_data_x_vector;
    vector<double> exp_data_y_vector;
    for (int i = 0; i < exp_data_size; i++) {
        exp_data_x_vector.push_back(exp_data_x[i]);
        exp_data_y_vector.push_back(exp_data_y[i]);
    }


    vector<double> model_data_x_vector;
    vector<double> model_data_y_vector;
    for (int i = 0; i < model_data_size; i++) {
        model_data_x_vector.push_back(model_data_x[i]);
        model_data_y_vector.push_back(model_data_y[i]);
    }
